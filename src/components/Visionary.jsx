      ...
      <div className=" max-w-4xl mx-auto my-6">
        <VerticalTimeline>
          ...
          >
            ...
            <p className="text-gray-300 text-sm mt-2">
                Aspiring Full Stack Web  Developer passionate about crafting exceptional user experiences.I bring fresh perspectives,boundaries ambition and unconventional thinking to every project.
            </p>
          </VerticalTimelineElement>
        </VerticalTimeline>
      </div>
