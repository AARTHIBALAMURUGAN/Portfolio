...
import { RiJavaLine, RiNodejsFill, RiReactjsFill } from "react-icons/ri";
import { SiExpress, SiMysql,SiMongodb, SiPostman } from "react-icons/si";
...
const Skills = () => {
    ...
    <div className=' flex items-center flex-col py-8 sm:py-12 ' id='skills'>
      ...
      <div className='relative bg-[#171721] box px-10 sm:px-20 py-7 sm:py-14 rounded-lg mx-2'>
          ...
          <div className='grid grid-cols-2 sm:grid-cols-3 gap-4 sm:gap-7'>
            ...
            <div className='flex gap-2 items-center justify-center   text-gray-300 border-1 px-3 py-2 rounded-2xl outline-0'>
              <RiReactjsFill className='size-6'  /> <p className='text-lg sm:text-xl'>React JS</p>
            </div>
            <div className='flex gap-2 items-center justify-center   text-gray-300 border-1 px-3 py-2 rounded-2xl outline-0'>
              <RiNodejsFill className='size-6'  /> <p className='text-lg sm:text-xl'>Node JS</p>
            </div>
            <div className='flex gap-2 items-center justify-center   text-gray-300 border-1 px-3 py-2 rounded-2xl outline-0'>
              <SiExpress className='size-6'  /> <p className='text-lg sm:text-xl'>Express JS</p>
            </div>
            <div className='flex gap-2 items-center justify-center   text-gray-300 border-1 px-3 py-2 rounded-2xl outline-0'>
              <SiMongodb className='size-6'  /> <p className='text-lg sm:text-xl'>Mongo DB</p>
            </div>
            <div className='flex gap-2 items-center justify-center   text-gray-300 border-1 px-3 py-2 rounded-2xl outline-0'>
              <RiJavaLine className='size-6'  /> <p className='text-lg sm:text-xl'>Java</p>
            </div>
            <div className='flex gap-2 items-center justify-center   text-gray-300 border-1 px-3 py-2 rounded-2xl outline-0'>
              <TbApi className='size-6'  /> <p className='text-lg sm:text-xl'>Rest Api's</p>
            </div>
            <div className='flex gap-2 items-center justify-center   text-gray-300 border-1 px-3 py-2 rounded-2xl outline-0'>
 ...
 <div className='flex gap-2 items-center justify-center   text-gray-300 border-1 px-3 py-2 rounded-2xl outline-0'>
              <SiPostman className='size-6'  /> <p className='text-lg sm:text-xl'>Postman</p>
            </div>
